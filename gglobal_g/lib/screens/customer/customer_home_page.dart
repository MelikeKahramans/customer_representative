...
import 'package:gglobal_g/screens/customer/sel_admin_page.dart';
import 'package:gglobal_g/screens/login_page.dart';
...
class CustomerHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Müşteri Ana Sayfası'),
      ),
      body: Center(
        child: Column(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => AdminSelectionPage(user: user)),
                  );
                },
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const ViewPricesPage()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  shape: RoundedRectangleBorder(
                ...
                child: const Text('Fiyat Listesi Görüntüle', style: TextStyle(fontSize: 18)),
              ),
            ),
            const SizedBox(height: 30),
            SizedBox(
